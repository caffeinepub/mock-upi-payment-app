...
export class Backend implements backendInterface {
    ...
    async getAllQRCodes(): Promise<Array<QRCode>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllQRCodes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBalanceByUser(arg0: Principal): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getBalanceByUser(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerQRCode(): Promise<QRCode | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerQRCode();
    ...
    async getCategorizedBankList(): Promise<Array<BankCategory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCategorizedBankList();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQRCodeByMobile(arg0: string): Promise<QRCode | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getQRCodeByMobile(arg0);
                return from_candid_opt_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTransactionHistoryByUser(arg0: Principal): Promise<Array<TransactionRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTransactionHistoryByUser(arg0);
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async linkBankAccount(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.linkBankAccount(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMoney(arg0: string, arg1: number): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_TransactionRecord_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TransactionRecord): TransactionRecord {
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_QRCode]): QRCode | null {
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        counterpartyMobile: value.counterpartyMobile,
        amount: value.amount
    };
}
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TransactionRecord>): Array<TransactionRecord> {
    return value.map((x)=>from_candid_TransactionRecord_n8(_uploadFile, _downloadFile, x));
}
